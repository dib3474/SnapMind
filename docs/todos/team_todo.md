...
- [x] `#19` Room FTS 통합 검색 쿼리 작성 `DB`
- [x] `#20` 검색 결과 Flow 스트림 및 ViewModel 구성 `CORE`
- [x] `#32` 휴지통 — 삭제 이미지 복구 로직 `CORE` — 복구(Phase 2) + 영구 삭제(개별/전체) + 파일 cleanup
- [x] `#33` PDF 추출 기능 구현 `CORE`
